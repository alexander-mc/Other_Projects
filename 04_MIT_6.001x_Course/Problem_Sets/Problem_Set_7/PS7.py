...
class NotTrigger(Trigger):
    ...
    def evaluate(self, story):
        return not self.word1.evaluate(story)
...
class AndTrigger(Trigger):
    ...
    def evaluate(self, story):
        return self.word1.evaluate(story) and self.word2.evaluate(story)
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, story):
        return self.word1.evaluate(story) or self.word2.evaluate(story)
